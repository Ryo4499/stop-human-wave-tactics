...
}).use(remarkBreaks).use(remarkGemoji).use(remarkGfm).use(remarkMath).use(remarkPlantuml).use(remarkCodeTitle).use(remarkRehype).use(rehypeHighlight, {
    ignoreMissing: true
}).use(rehypeExternalLinks, {
    rel: ['nofollow']
}).use(rehypeFmt)
    .use(rehypeKatex).use(rehypeSlug).use(rehypeToc).use(rehypeAutolinkHeadings).use(rehypeStringify).processSync(content).value
